...
let photosAdmiral = [{
	link: "./src/img/admiral/smallhall.jpg",
	title: "Small coffee hall"
}, {
	link: "./src/img/admiral/kitchen.jpg",
	title: "Kitchen"
}, {
	link: "./src/img/admiral/livingroom.jpg",
	title: "Living room"
}, {
	link: "./src/img/admiral/childroom.jpg",
	title: "Childroom"
}, {
	link: "./src/img/admiral/bedroom.jpg",
	title: "Bedroom"
}, {
	link: "./src/img/admiral/bathroom.jpg",
	title: "Bathroom"
}];

let photosSochi = [{
	link: "./src/img/sochi/livingroom.jpg",
	title: "Livingroom"
}, {
	link: "./src/img/sochi/kitchen.jpg",
	title: "Kitchen"
}, {
	link: "./src/img/sochi/bathroom_1.jpg",
	title: "Bathroom 1"
}, {
	link: "./src/img/sochi/childroom.jpg",
	title: "Childroom"
}, {
	link: "./src/img/sochi/bedroom.jpg",
	title: "Bedroom"
}, {
	link: "./src/img/sochi/bathroom_2.jpg",
	title: "Bathroom 2"
}];

let photosPatriot = [{
	link: "./src/img/patriot/livingroom.jpg",
	title: "Livingroom"
}, {
	link: "./src/img/patriot/bedroom_1.jpg",
	title: "Bedroom 1"
}, {
	link: "./src/img/patriot/bathroom_1.jpg",
	title: "Bathroom 1"
}, {
	link: "./src/img/patriot/childroom.jpg",
	title: "Childroom"
}, {
	link: "./src/img/patriot/bedroom_2.jpg",
	title: "Bedroom 2"
}, {
	link: "./src/img/patriot/bathroom_2.jpg",
	title: "Bathroom 2"
}];
